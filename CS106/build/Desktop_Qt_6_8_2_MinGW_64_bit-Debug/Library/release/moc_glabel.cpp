...
static constexpr auto qt_meta_stringdata_ZN16_Internal_QLabelE = QtMocHelpers::stringData(
    "_Internal_QLabel",
    "clicked",
    "",
    "doubleClicked"
...
Q_CONSTINIT static const uint qt_meta_data_ZN16_Internal_QLabelE[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QLabel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN16_Internal_QLabelE.offsetsAndSizes,
    qt_meta_data_ZN16_Internal_QLabelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN16_Internal_QLabelE_t,
        // Q_OBJECT / Q_GADGET
...
void _Internal_QLabel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (_Internal_QLabel::*)();
            if (_q_method_type _q_method = &_Internal_QLabel::clicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (_Internal_QLabel::*)();
            if (_q_method_type _q_method = &_Internal_QLabel::doubleClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *_Internal_QLabel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN16_Internal_QLabelE.stringdata0))
