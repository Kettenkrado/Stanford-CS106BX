...
static constexpr auto qt_meta_stringdata_ZN20_Internal_QScrollBarE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20_Internal_QScrollBarE[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QScrollBar::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20_Internal_QScrollBarE.offsetsAndSizes,
    qt_meta_data_ZN20_Internal_QScrollBarE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20_Internal_QScrollBarE_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QScrollBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20_Internal_QScrollBarE.stringdata0))
