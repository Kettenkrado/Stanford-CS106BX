...
static constexpr auto qt_meta_stringdata_ZN17_Internal_QCanvasE = QtMocHelpers::stringData(
    "_Internal_QCanvas",
    "doubleClicked",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17_Internal_QCanvasE[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QCanvas::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17_Internal_QCanvasE.offsetsAndSizes,
    qt_meta_data_ZN17_Internal_QCanvasE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17_Internal_QCanvasE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<_Internal_QCanvas, std::true_type>,
...
void _Internal_QCanvas::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (_Internal_QCanvas::*)();
            if (_q_method_type _q_method = &_Internal_QCanvas::doubleClicked; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *_Internal_QCanvas::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17_Internal_QCanvasE.stringdata0))
