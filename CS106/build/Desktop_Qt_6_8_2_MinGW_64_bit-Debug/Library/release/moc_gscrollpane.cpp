...
static constexpr auto qt_meta_stringdata_ZN21_Internal_QScrollAreaE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21_Internal_QScrollAreaE[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QScrollArea::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21_Internal_QScrollAreaE.offsetsAndSizes,
    qt_meta_data_ZN21_Internal_QScrollAreaE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21_Internal_QScrollAreaE_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QScrollArea::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21_Internal_QScrollAreaE.stringdata0))
