...
static constexpr auto qt_meta_stringdata_ZN19_Internal_QComboBoxE = QtMocHelpers::stringData(
    "_Internal_QComboBox",
    "handleChange",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN19_Internal_QComboBoxE[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QComboBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN19_Internal_QComboBoxE.offsetsAndSizes,
    qt_meta_data_ZN19_Internal_QComboBoxE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN19_Internal_QComboBoxE_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QComboBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN19_Internal_QComboBoxE.stringdata0))
