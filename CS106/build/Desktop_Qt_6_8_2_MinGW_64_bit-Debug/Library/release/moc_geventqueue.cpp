...
static constexpr auto qt_meta_stringdata_ZN11GEventQueueE = QtMocHelpers::stringData(
    "GEventQueue",
    "eventReady",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN11GEventQueueE[] = {
...
Q_CONSTINIT const QMetaObject GEventQueue::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11GEventQueueE.offsetsAndSizes,
    qt_meta_data_ZN11GEventQueueE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11GEventQueueE_t,
        // Q_OBJECT / Q_GADGET
...
void GEventQueue::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (GEventQueue::*)();
            if (_q_method_type _q_method = &GEventQueue::eventReady; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *GEventQueue::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11GEventQueueE.stringdata0))
