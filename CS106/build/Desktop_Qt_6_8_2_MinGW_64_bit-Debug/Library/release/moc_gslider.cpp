...
static constexpr auto qt_meta_stringdata_ZN17_Internal_QSliderE = QtMocHelpers::stringData(
    "_Internal_QSlider",
    "handleChange",
    "",
    "value"
...
Q_CONSTINIT static const uint qt_meta_data_ZN17_Internal_QSliderE[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QSlider::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17_Internal_QSliderE.offsetsAndSizes,
    qt_meta_data_ZN17_Internal_QSliderE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17_Internal_QSliderE_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QSlider::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17_Internal_QSliderE.stringdata0))
