...
static constexpr auto qt_meta_stringdata_ZN20_Internal_QContainerE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN20_Internal_QContainerE[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QContainer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN20_Internal_QContainerE.offsetsAndSizes,
    qt_meta_data_ZN20_Internal_QContainerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN20_Internal_QContainerE_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QContainer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN20_Internal_QContainerE.stringdata0))
