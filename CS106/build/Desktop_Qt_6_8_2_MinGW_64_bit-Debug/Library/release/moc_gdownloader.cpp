...
static constexpr auto qt_meta_stringdata_ZN11GDownloaderE = QtMocHelpers::stringData(
    "GDownloader",
    "downloaded",
    "",
    "downloadInternal",
...
Q_CONSTINIT static const uint qt_meta_data_ZN11GDownloaderE[] = {
...
Q_CONSTINIT const QMetaObject GDownloader::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN11GDownloaderE.offsetsAndSizes,
    qt_meta_data_ZN11GDownloaderE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN11GDownloaderE_t,
        // Q_OBJECT / Q_GADGET
...
void GDownloader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (GDownloader::*)();
            if (_q_method_type _q_method = &GDownloader::downloaded; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *GDownloader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN11GDownloaderE.stringdata0))
