...
static constexpr auto qt_meta_stringdata_ZN21_Internal_QMainWindowE = QtMocHelpers::stringData(
...
Q_CONSTINIT static const uint qt_meta_data_ZN21_Internal_QMainWindowE[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QMainWindow::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN21_Internal_QMainWindowE.offsetsAndSizes,
    qt_meta_data_ZN21_Internal_QMainWindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN21_Internal_QMainWindowE_t,
        // Q_OBJECT / Q_GADGET
...
void *_Internal_QMainWindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN21_Internal_QMainWindowE.stringdata0))
